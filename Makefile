...
PARSER = ft_socket.c ft_parse_arg.c
SOLVER = ft_ping_icmp_echo_req.c ft_ping_icmp_echo_reply.c ft_ping_once.c
HELPER_FUNC = helper_func.c icmp_helper.c ft_newton.c ft_strcmp.c ft_strncmp.c \
			  ft_atoi.c ft_strlen.c
PRINT = ft_print.c ft_print_helper.c ft_print_arg_error.c
MAIN = main.c
